...
@Row {
    ...
    @Column {
        ![SudoLogImage generated by Chat-GPT](PageLog)
    }
} 

### Tab

탭을 사용해서 스크롤 길이를 단축시켰습니다. 아래에서 SudoLog 이미지의 Light, Dark 모드를 확인할 수 있습니다.
...
@TabNavigator {
    ...
    @Tab("dark") {
        ![SudoLogImage generated by Chat-GPT](pageLog@Dark)
    }
} 
...
Documentation을 생성하면 제목에는 프로젝트 이름이 들어갑니다. 이 프로젝트의 이름은 ``UILog``이므로, 이 프로젝트 내에서 생성시 첫 라인은 다음과 같습니다.
