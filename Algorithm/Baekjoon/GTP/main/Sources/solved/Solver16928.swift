...
struct Solver16928 {
    ...
    mutating func move(nextPosition currentPosition: Int, newMoveCountToCurrentPosition: Int) {
...
private func readChairAndSnakeNumbers() -> (Int, Int) {
    let input = readLine()
    let numbers = input?.split(separator: " ").compactMap { Int($0) }
