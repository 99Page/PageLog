struct ResultHeap<Element: Comparable> {
...
struct Heap<Element: Comparable> {
    ...
    mutating func siftUp(index: Int) {
        ...
        while hasHigherPriorityThanParent(index: index) {
            
        }
    }
    
    private func hasHigherPriorityThanParent(index: Int) -> Bool {
        let parentIndex = findParentIndex(childIndex: index)
        return comparator(elements[parentIndex], elements[index])
    }
    
    private func findParentIndex(childIndex: Int) -> Int {
